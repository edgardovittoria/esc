...
public class RegistroNotifiche {
	...
	public void salvaNotifica(Notifica notificaDaSalvare) {
		getListaNotifiche().add(notificaDaSalvare);
		getNotificaRepository().save(notificaDaSalvare);
	}

	public void aggiornaNotificaSuDatabase(Notifica notificaDaAggiornare) {
		getNotificaRepository().save(notificaDaAggiornare);
	}
}
